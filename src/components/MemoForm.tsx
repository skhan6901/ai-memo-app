...
export default function MemoForm({
  ...
  const [contentViewMode, setContentViewMode] = useState<'edit' | 'preview'>(
    'edit'
  )
            ...
            <div>
              <div className="mb-2 flex flex-wrap items-center justify-between gap-2">
                ...
                >
                  <button
                    type="button"
                    role="tab"
                    aria-selected={contentViewMode === 'edit'}
                  ...
                  <button
                    type="button"
                    role="tab"
                    aria-selected={contentViewMode === 'preview'}
              ...
              {contentViewMode === 'edit' ? (
                ...
                <div
                  ...
                  className="min-h-[12rem] w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-3"
                >
